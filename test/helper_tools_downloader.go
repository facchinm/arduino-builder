...
func DownloadCoresAndToolsAndLibraries(t *testing.T) {
	...
	tools := []Tool{
		...
		Tool{Name: "arduino-preprocessor", Version: "0.1.4",
			OsUrls: []OsUrl{
				OsUrl{Os: "i686-pc-linux-gnu", Url: "https://github.com/arduino/arduino-preprocessor/releases/download/0.1.4/arduino-preprocessor-0.1.4-i686-pc-linux-gnu.tar.bz2"},
				OsUrl{Os: "x86_64-pc-linux-gnu", Url: "https://github.com/arduino/arduino-preprocessor/releases/download/0.1.4/arduino-preprocessor-0.1.4-x86_64-pc-linux-gnu.tar.bz2"},
				OsUrl{Os: "i686-mingw32", Url: "https://github.com/arduino/arduino-preprocessor/releases/download/0.1.4/arduino-preprocessor-0.1.4-i686-w64-mingw32.tar.bz2"},
				OsUrl{Os: "x86_64-apple-darwin", Url: "https://github.com/arduino/arduino-preprocessor/releases/download/0.1.4/arduino-preprocessor-0.1.4-x86_64-apple-darwin11.tar.bz2"},
				OsUrl{Os: "arm-linux-gnueabihf", Url: "https://github.com/arduino/arduino-preprocessor/releases/download/0.1.4/arduino-preprocessor-0.1.4-armhf-pc-linux-gnu.tar.bz2"},
			},
		},
	}
